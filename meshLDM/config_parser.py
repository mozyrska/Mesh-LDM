...
def read_config_encode_decode(fname, mode):
    '''
    ...
    if mode == 'encode':
        config_parms['encoded_output_dir'] = config.get('Encoder', 'encoded_output_dir')

    elif mode == 'decode':
        config_parms['denoised_dir'] = config.get('Decoder', 'denoised_dir')
        config_parms['decoded_output_dir'] = config.get('Decoder', 'decoded_output_dir')
